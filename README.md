...
* Skills
  ...
  Skills are generated based on the list of skills for the role for a street rat from the rulebook: the list is taken and scaled according to rank. The lowest rank has a skill sum of 50, the highest has a skill sum of 110.
...
Input:
```
python Source/main.py --rank=general --role=solo
```
